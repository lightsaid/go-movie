...
import (
	...
	"lightsaid.com/go-movie/booking/cmd/web/handlers"
...
func main() {
	// 加载配置
	var config utils.WebConfig
	if err := utils.LoadConfig(".", "WebConfig", &config); err != nil {
	...
	// 加载Server
	srv := handlers.NewServer(&config, q)
